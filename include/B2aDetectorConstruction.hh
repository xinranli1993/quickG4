...
class B2aDetectorConstruction : public G4VUserDetectorConstruction
{
 ...
 //   void SetChamberMaterial(G4String );
  ...
  private:
    ...
    G4Material*        fTargetLHeMaterial;  // pointer to the target  material
    G4Material*        fTargetSiMaterial;  // pointer to the target  material
    G4Material*        fTargetSapphireMaterial;  // pointer to the target  material
    G4Material*        fTargetGaAsMaterial;  // pointer to the target  material
    G4Material*        fTargetMaterial;  // pointer to the target  material
    G4Material*        fChamberMaterial; // pointer to the chamber material
    G4Material*        f300KChamberMaterial; // pointer to the chamber material
